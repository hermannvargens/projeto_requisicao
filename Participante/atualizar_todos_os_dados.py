                    ...
                    if '160224 - PQ R MNT/5' in cols[0].text:
                        ...
                        for row in tables[1].find_all('tr'):
                            ...
                            if len(cols) >= 4:
                                ...
                                if 'Gerenciadora' in cols[1].text:
                                    uasg_gerenciadora = cols[0].text
                                    #print(f'UASG Gerenciadora: {uasg_gerenciadora}')
...
def obter_unidade_objeto(df_itens_novos):
    ...
    print(f'Dados de Objeto e Unidade de Fornecimento obtidos sucesso. A tabela tem {len(df_itens_novos_site_antigo)} linhas.')
